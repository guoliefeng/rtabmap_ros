...
Generated: 2026-08-08T12:30:00+08:00

## Input files

- Matched files: **99**
- Total indexed duration: **697.730 s**
...
PASS: **IMU quaternion** — finite and non-zero in 746 sampled messages
PASS: **IMU orientation covariance** — covariance[0] != -1 in 746 sampled messages
...
|---|---|---:|---:|---|---|---|---|---|
| `/lidar_left_front` | `sensor_msgs/PointCloud2` | 6946 | 10.000 Hz | `lidar_left_front` | `x(FLOAT32@0), y(FLOAT32@4), z(FLOAT32@8), intensity(FLOAT32@16), timestamp(FLOAT64@24), ring(UINT16@32)` | PASS | yes | yes |
| `/lidar_preprocessor/meta_cloud` | `sensor_msgs/PointCloud2` | 6933 | 10.000 Hz | `base_link` | `x(FLOAT32@0), y(FLOAT32@4), z(FLOAT32@8), intensity(FLOAT32@16)` | PASS | no | no |
| `/lidar_right_rear` | `sensor_msgs/PointCloud2` | 6945 | 10.001 Hz | `lidar_right_rear` | `x(FLOAT32@0), y(FLOAT32@4), z(FLOAT32@8), intensity(FLOAT32@16), timestamp(FLOAT64@24), ring(UINT16@32)` | PASS | yes | yes |

## Candidate topics

- `/ins_driver/imu`: `sensor_msgs/Imu`, **69461** messages, indexed rate **94.049 Hz**
- `/lidar_preprocessor/meta_cloud`: `sensor_msgs/PointCloud2`, **6933** messages, indexed rate **10.000 Hz**
- `/localization/ins`: `nav_msgs/Odometry`, **62638** messages, indexed rate **45683.634 Hz**
